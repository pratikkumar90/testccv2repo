...
/**
 * This is the extension manager of the Testemptyext extension.
 */
public class TestemptyextManager extends GeneratedTestemptyextManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(TestemptyextManager.class);
	 ...
	 */
	public static TestemptyextManager getInstance()
	{
		return (TestemptyextManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(TestemptyextConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TestemptyextManager() // NOPMD 
	{
		LOG.debug("constructor of TestemptyextManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of TestemptyextManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of TestemptyextManager called, current tenant: {}", getTenant().getTenantID());
	}
