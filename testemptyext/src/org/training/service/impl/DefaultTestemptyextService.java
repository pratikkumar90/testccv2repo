...
public class DefaultTestemptyextService implements TestemptyextService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultTestemptyextService.class);
	...
	{
		return DefaultTestemptyextService.class.getResourceAsStream("/testemptyext/sap-hybris-platform.png");
	}
