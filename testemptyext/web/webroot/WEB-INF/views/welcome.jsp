...
<html>
<head>
    <title>Welcome to testemptyext</title>
    <link rel="stylesheet" href="<c:url value="/static/testemptyext-webapp.css"/>" type="text/css"
          media="screen, projection"/>
</head>
<div class="container">
    <img src="<c:url value="${logoUrl}" />" alt="Hybris platform logo"/>

    <h2>Welcome to "testemptyext" extension</h2>
    ...
    <div>
        ...
        <ul>
            <li><b>resources/testemptyext-items.xml</b> - here you can model your items</li>
            <li><b>resources/testemptyext-spring.xml</b> - here you can define your services</li>
            <li><b>web/webroot/WEB-INF/config/testemptyext-spring-mvc-config.xml</b> - here is a Spring MVC related
                configuration
            </li>
            <li><b>web/webroot/WEB-INF/config/testemptyext-web-app-config.xml</b> - here you can define web related services,
                facades etc.
            </li>
            <li><b>web/webroot/WEB-INF/config/testemptyext-spring-security-config.xml</b> - here you can configure your Spring Security settings</li>
